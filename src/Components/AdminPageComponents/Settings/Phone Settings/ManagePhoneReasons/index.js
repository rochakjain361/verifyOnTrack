...
const rows = [
    {
        "phoneReasons": "phoneReasons1",
    },
    {
        "phoneReasons": "phoneReasons2"
    },
    {
        "phoneReasons": "phoneReasons3",
    },
    {
        "phoneReasons": "phoneReasons4"
    }
];
                    ...
                    <Grid item xs={6}>
                        <Autocomplete
                            ...
                            renderInput={(params) => <TextField {...params} 
                              ...
                              label="Search phone Reasons" margin="normal" variant='outlined' size='small' />}
                        />
                    </Grid>
                        ...
                        <Table stickyHeader>
                            <TableHead>
                                <TableRow style={{ backgroundColor: 'black' }}>
                                    <TableCell align="left">Phone Types</TableCell>
                            ...
                            <TableBody>
                                {rows.map((row, index) => (
                                    <TableRow key={row.id}>
                                        <TableCell align="left">{row.phoneReasons}</TableCell>
