...
export default class choicequstions extends Component {
    ...
    async addid() {
        ...
        await 
          post(
            "http://3.22.17.212:8000/api/v1/resManager/job/surveyq/employer/choice/",token,
            bodyFormData,
      ...
      async deleteid(id) {
        await del(
          "http://3.22.17.212:8000/api/v1/resManager/job/surveyq/employer/choice/" + id + "/",
          token,""
        );
        this.getid();
      }
    isloading() {
      ...
      async getid() {
        ...
        await get("http://3.22.17.212:8000/api/v1/resManager/job/surveyq/employer/choice/",token,"")
      .then((res) => {
