...
export class index extends Component {
  ...
  async getstates() {
    ...
    await axios
      .get("http://3.22.17.212:8000/api/v1/resManager/job/offboardTypes/", {
        headers: {
          Authorization: token,
        },
      })
  ...
  async addState() {
    ...
    bodyFormData.append("offboardType", this.state.stateName);
  ...
  async deleteState(id) {
    ...
    // console.log("......",id)
     axios.delete(
      "http://3.22.17.212:8000/api/v1/resManager/job/offboardTypes/" + id + "/",
      {
        headers: {
          Authorization: token,
        },
    ...
    return (
      <>
        <Grid container justify="space-between" alignItems="center" spacing={4}>
          <Grid item>
            <Typography variant="h4">Offboard Types</Typography>
          </Grid>

          <Grid item xs={6}>
            <Autocomplete
              options={result}
              getOptionLabel={(option) => option.offboardType}
              size="small"
              id="states"
              Username
            ...
            <Table stickyHeader>
              <TableHead>
                <TableRow style={{ backgroundColor: "black" }}>
                  <TableCell align="left">Offboard Id</TableCell>
                  <TableCell align="center">Offboard Type</TableCell>
              ...
              <TableBody>
                {this.state.result.map((row, index) => (
                  <TableRow key={row.id}>
                    ...
                    <TableCell align="center">{row.offboardType}</TableCell>
