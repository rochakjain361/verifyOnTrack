...
export class index extends Component {
  ...
  async getstates() {
    ...
    await axios
      .get("http://3.22.17.212:8000/api/v1/resManager/employer/categories/", {
        headers: {
          Authorization: token,
        },
      })
  ...
  async addState() {
    ...
    bodyFormData.append("category", this.state.stateName);
    ...
    return (
      <>
        <Grid container justify="space-between" alignItems="center" spacing={4}>
          <Grid item>
            <Typography variant="h4">Industry Categories</Typography>
          </Grid>
            ...
            <Table stickyHeader>
              <TableHead>
                <TableRow style={{ backgroundColor: "black" }}>
                  <TableCell align="left">Industry Id</TableCell>
                  <TableCell align="center">Industry Category</TableCell>
